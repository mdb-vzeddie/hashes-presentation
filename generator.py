...
for count in range(0, n):
    ...
    account_map.append({"username": new_username, "pw": pw_plain.decode('ascii'), 'md5': pw_md5, 'sha2': pw_sha2, 'salt': salt.decode('ascii'), 'pw_md5_salt': pw_md5_salt, 'id': str(count + 1)})
